...
class StoreLmsBankSoalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tipe_soal' => ['required', 'string', Rule::in(['pg', 'esai', 'benar_salah', 'menjodohkan', 'isian'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'kisi_kisi_id.exists' => 'Kisi-kisi Ujian yang dipilih tidak valid.',
