...
/**
 * Class UbahKelasRequest
 * Validasi pembaruan data kelas / rombel.
 */
class UbahKelasRequest extends FormRequest
{
    ...
    /**
     * Custom validation callback untuk pembaruan data.
     */
    public function withValidator(Validator $validator): void
    {
        $validator->after(function ($validator) {
            ...
            // 1. Cek duplikasi Nama Kelas pada Unit & Semester yang sama kecuali untuk data kelas ini sendiri
