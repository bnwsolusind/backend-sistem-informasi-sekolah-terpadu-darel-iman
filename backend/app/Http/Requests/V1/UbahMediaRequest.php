...
class UbahMediaRequest extends FormRequest
{
    ...
    {
        return [
            'materi_id' => ['sometimes', 'required', 'uuid', 'exists:lms_materi,id'],
            'nama_file' => ['sometimes', 'required', 'string', 'max:255'],
            'tipe_file' => ['sometimes', 'required', 'string', 'in:pdf,video,audio,ppt,word,image,link'],
            'file' => ['nullable', 'file', 'mimes:pdf,mp4,webm,mp3,wav,ppt,pptx,doc,docx,jpg,jpeg,png,webp', 'max:51200'],
