...
1. [HARDCODE_AUDIT.md](file:///Applications/XAMPP/xamppfiles/htdocs/Sistem-Manajemen-Sekolah-terpadu-main/docs/ai/HARDCODE_AUDIT.md)
2. [DATABASE_SOURCE_OF_TRUTH_MATRIX.md](file:///Applications/XAMPP/xamppfiles/htdocs/Sistem-Manajemen-Sekolah-terpadu-main/docs/ai/DATABASE_SOURCE_OF_TRUTH_MATRIX.md)
3. [DEMO_DATASET_REPORT.md](file:///Applications/XAMPP/xamppfiles/htdocs/Sistem-Manajemen-Sekolah-terpadu-main/docs/ai/DEMO_DATASET_REPORT.md)
4. [BROWSER_E2E_REPORT.md](file:///Applications/XAMPP/xamppfiles/htdocs/Sistem-Manajemen-Sekolah-terpadu-main/docs/ai/BROWSER_E2E_REPORT.md)
5. [ROLE_FLOW_MATRIX.md](file:///Applications/XAMPP/xamppfiles/htdocs/Sistem-Manajemen-Sekolah-terpadu-main/docs/ai/ROLE_FLOW_MATRIX.md)
...
8. [SESSION_13_FINAL_REPORT.md](file:///Applications/XAMPP/xamppfiles/htdocs/Sistem-Manajemen-Sekolah-terpadu-main/docs/ai/SESSION_13_FINAL_REPORT.md)
