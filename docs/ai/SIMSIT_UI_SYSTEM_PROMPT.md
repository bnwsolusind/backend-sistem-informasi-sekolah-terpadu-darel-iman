...
> Dokumen eksekusi utama. Sebelum menjalankan instruksi ini, AI/Codex wajib membaca seluruh rulebook pada `docs/ai/`.

## Urutan Prioritas Aturan
1. `UI_RULEBOOK.md`
2. `DESIGN_SYSTEM.md`
3. `COMPONENT_RULEBOOK.md`
4. `RESPONSIVE_RULEBOOK.md`
5. `MOTION_RULEBOOK.md`
...
- Terapkan animasi hanya melalui preset global pada `MOTION_RULEBOOK.md`.
...
============================================================
INTEGRASI MOTION RULEBOOK
============================================================

Selain seluruh aturan di atas, wajib membaca dan menerapkan `docs/ai/MOTION_RULEBOOK.md`.

Tambahkan:
- `MotionProvider` dan pengaturan animasi aktif/nonaktif/reduced;
- `src/config/motion-presets.ts` sebagai satu-satunya sumber preset animasi;
- page transition, drawer, modal, dropdown, toast, sidebar, card, button, notification, table feedback, KPI, chart, dan bottom navigation menggunakan preset global;
- fallback reduced motion;
- pengujian performa dan layout shift.

Dilarang membuat animasi lokal yang tidak terdaftar pada Motion Rulebook.
