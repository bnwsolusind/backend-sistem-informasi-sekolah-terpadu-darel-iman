...
Sebelum mengubah kode, baca seluruh file berikut:

- `docs/ai/SIMSIT_UI_SYSTEM_PROMPT.md`
- `docs/ai/UI_RULEBOOK.md`
- `docs/ai/DESIGN_SYSTEM.md`
- `docs/ai/COMPONENT_RULEBOOK.md`
- `docs/ai/RESPONSIVE_RULEBOOK.md`
- `docs/ai/MOTION_RULEBOOK.md`
- `docs/ai/ICON_RULEBOOK.md`
- `docs/ai/COLOR_RULEBOOK.md`
- `docs/ai/TYPOGRAPHY_RULEBOOK.md`
- `docs/ai/CRUD_RULEBOOK.md`
- `docs/ai/TABLE_RULEBOOK.md`
- `docs/ai/PROFILE_RULEBOOK.md`
- `docs/ai/NOTIFICATION_RULEBOOK.md`
- `docs/ai/DASHBOARD_RULEBOOK.md`
- `docs/ai/MOBILE_RULEBOOK.md`
- `docs/ai/ACCESSIBILITY_RULEBOOK.md`
