...
const MOCK_FALLBACK_CHILDREN = [
  {
    ...
    unit_code: 'SDIT',
    kelas: { nama_kelas: 'Kelas 5 Al-Bukhari' },
    is_pesantren: false,
  ...
  },
  {
    ...
    unit_code: 'SMPIT',
    kelas: { nama_kelas: 'Kelas 8 Khadijah' },
    is_pesantren: false,
  ...
  },
  {
    ...
    unit_code: 'PONPES',
    kelas: { nama_kelas: 'Kelas 11 IPA 1 (Santri Asrama)' },
    is_pesantren: true,
...
const menu = [
  ...
  ['bills', 'Tagihan', WalletCards, 'bg-emerald-100/90 text-emerald-800 border-emerald-300/90 hover:bg-emerald-200'],
]
  ...
  useEffect(() => {
    familyPortalService
      ...
      .then((r) => {
        ...
        // Merging API children with MOCK dataset for multi-unit demonstration if needed
        const combined = apiChildren.length > 0 ? apiChildren : MOCK_FALLBACK_CHILDREN
      ...
      .catch(() => {
        ...
        setChildId(MOCK_FALLBACK_CHILDREN[0].id)
        setLoading(false)
      })
  }, [requestedChild])
