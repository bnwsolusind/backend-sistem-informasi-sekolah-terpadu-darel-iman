  ...
  return (
    <PageContainer className="space-y-6 pb-12">
      <motion.div initial="hidden" animate="visible" variants={containerVariants} className="space-y-6">
        ...
        {/* MODERN HERO CARD HEADER (MATCHING FOUNDATION PROFILE PAGE STYLE) */}
        <motion.div variants={itemVariants} className="relative overflow-hidden rounded-[22px] border-2 border-emerald-500/30 bg-gradient-to-r from-emerald-500/15 via-teal-500/10 to-emerald-600/15 p-5 sm:p-6 shadow-md shadow-emerald-500/10 dark:border-emerald-600/40 dark:bg-gradient-to-r dark:from-emerald-950/70 dark:via-teal-950/50 dark:to-slate-900 print:hidden">
          ...
          <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2.5 shrink-0 z-10 self-end sm:self-center">
              <div className="flex items-center gap-2 px-3.5 py-2 bg-emerald-500/10 dark:bg-emerald-950/50 rounded-xl text-emerald-700 dark:text-emerald-300 text-xs font-extrabold border border-emerald-500/30 shadow-xs">
        ...
        {/* 2. Tabs Bar (Restored Previous Multi-Color Pastel Squircle Button Style) */}
        <motion.nav variants={itemVariants} className="rounded-[18px] border border-slate-200/80 bg-white p-3.5 shadow-xs dark:border-slate-800 dark:bg-[#1B2433]">
        ...
        <motion.div variants={itemVariants} className="transition-all duration-200">
